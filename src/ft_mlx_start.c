...
void	load_images(t_struct *map)
{
	...
	map->flr = mlx_xpm_file_to_image(map->mlx, "char/floor.xpm", &x, &y);
	map->lef = mlx_xpm_file_to_image(map->mlx, "char/left.xpm", &x, &y);
	map->rig = mlx_xpm_file_to_image(map->mlx, "char/right.xpm", &x, &y);
	map->up = mlx_xpm_file_to_image(map->mlx, "char/up.xpm", &x, &y);
	map->dow = mlx_xpm_file_to_image(map->mlx, "char/down.xpm", &x, &y);
	map->col = mlx_xpm_file_to_image(map->mlx, "char/gs.xpm", &x, &y);
	map->dc = mlx_xpm_file_to_image(map->mlx, "char/recall0.xpm", &x, &y);
	map->dro = mlx_xpm_file_to_image(map->mlx, "char/recall1.xpm", &x, &y);
}
